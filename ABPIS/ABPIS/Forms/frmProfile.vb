...
Public Class frmProfile
    ...
    Private Sub reloadProfessions()
        Dim mydata As DataTable = mysql.Query("SELECT DISTINCT profession from tblp_info")
        With txtProfession
            .AutoCompleteMode = AutoCompleteMode.SuggestAppend
            For i As Integer = 0 To mydata.Rows.Count - 1
                .AutoCompleteSourceCustomSource.Add(mydata.Rows(i).Item(0))
            Next
            .AutoCompleteSource = AutoCompleteSource.CustomSource
        End With

        mydata = mysql.Query("SELECT DISTINCT sProfession from tblp_info")
        With txtProfession2
            .AutoCompleteMode = AutoCompleteMode.SuggestAppend
            For i As Integer = 0 To mydata.Rows.Count - 1
                .AutoCompleteSourceCustomSource.Add(mydata.Rows(i).Item(0))
        ...
        mydata = mysql.Query("SELECT DISTINCT sOtherSpecify from tblp_info")
        With txtOtherSpecify2
            .AutoCompleteMode = AutoCompleteMode.SuggestAppend
            For i As Integer = 0 To mydata.Rows.Count - 1
                .AutoCompleteCustomSource.Add(mydata.Rows(i).Item(0))
            Next
        ...
        mydata = mysql.Query("SELECT DISTINCT dueTo from tblp_info order by dueTo")
        With cboInactive
            .Items.Clear()
            For i As Integer = 0 To mydata.Rows.Count - 1
    ...
    Private Sub Recordload()
        ...
        If mydata.Rows.Count > 0 Then
            With mydata.Rows(0)
                ...
                txtOtherSpecify.Text = .Item("otherSpecify")
                txtEmployer.Text_ = .Item("employer")
                txtOccupation.Text_ = .Item("occupation")
                txtProfession.Text_ = .Item("profession")
                ...
                txtOtherSpecify2.Text = .Item("sOtherSpecify")
                txtSEmployer.Text_ = .Item("Semployer")
                txtSOccupation.Text_ = .Item("Soccupation")
                txtProfession2.Text_ = .Item("sProfession")
            ...
            For i As Integer = 0 To mydata.Rows.Count - 1
                ...
                dgvWeddingAnn.Rows(i).Cells(1).Value = mydata.Rows(i).Item("month")
                dgvWeddingAnn.Rows(i).Cells(2).Value = mydata.Rows(i).Item("day")
                dgvWeddingAnn.Rows(i).Cells(3).Value = mydata.Rows(i).Item("year")
    ...
    Private Sub recordSave()
        If txtSurname.Text_ <> "" And txtFName.Text_ <> "" And Not udtBirthdate.Value Is Nothing And cboStatus.SelectedIndex <> -1 And cboSex.SelectedIndex <> -1 Then
            With mysql
                ...
                If IsNumeric(txtAge.Text_) Then .addValue(Age(udtBirthdate.Value), "age")
                ...
                .addValue(txtOtherSpecify.Text, "otherSpecify")
                .addValue(txtEmployer.Text_, "employer")
                .addValue(txtOccupation.Text_, "occupation")
                .addValue(txtProfession.Text_, "profession")
                ...
                If IsNumeric(txtSAge.Text_) Then .addValue(Age(udtSBirthDate.Value), "Sage")
                ...
                .addValue(txtOtherSpecify2.Text, "sOtherSpecify")
                .addValue(txtSEmployer.Text_, "Semployer")
                .addValue(txtSOccupation.Text_, "Soccupation")
                .addValue(txtProfession2.Text_, "sProfession")
                ...
                .addValue(cboInactive.Text, "dueTo")
            ...
            For i As Integer = 0 To dgvWeddingAnn.RowCount - 1
                With mysql
                    ...
                    .addValue((dgvWeddingAnn.Rows(i).Cells(1).Value), "month")
                    .addValue((dgvWeddingAnn.Rows(i).Cells(2).Value), "day")
                    .addValue((dgvWeddingAnn.Rows(i).Cells(3).Value), "year")
                    .Insert()
                End With
            Next
            '''''''''''''''''''''''
...
#Region "VALIDATION"
    ...
    Private Sub dgvWeddingAnn_RowsAdded(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewRowsAddedEventArgs) Handles dgvWeddingAnn.RowsAdded
        dgvWeddingAnn.Rows(dgvWeddingAnn.RowCount - 1).Cells(1).Value = "Jan"
    End Sub
        ...
        Select Case dgvNameChildren.CurrentCell.ColumnIndex
            Case 1
                If IsDate(dgvNameChildren.CurrentRow.Cells(1).Value) Then
                    ...
                    dgvNameChildren.CurrentRow.Cells(2).Value = Age(dt)
                Else
...
#End Region
            ...
            Case "TypeAToolStripMenuItem"
                ...
                With myCR
                    ...
                    For i As Integer = 0 To dgvWeddingAnn.RowCount - 1
                        ...
                        PowerNET8.myString.Share.Concat.Append(x, dgvWeddingAnn.Rows(i).Cells(0).Value.ToString + " - " + dgvWeddingAnn.Rows(i).Cells(1).Value.ToString + ". " + dgvWeddingAnn.Rows(i).Cells(2).Value.ToString + ", " + dgvWeddingAnn.Rows(i).Cells(3).Value.ToString)
                    Next
    ...
    Private Sub cboEducationalAttainment_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cboEducationalAttainment.SelectedIndexChanged
        If cboEducationalAttainment.SelectedIndex = 5 Then
            cboEducationalAttainment.Width = 93
            txtOtherSpecify.Visible = True
            txtOtherSpecify.Focus()
        Else
            cboEducationalAttainment.Width = 263
            txtOtherSpecify.Visible = False
        End If
    End Sub

    Private Sub cboSEducAttain_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cboSEducAttain.SelectedIndexChanged
        If cboSEducAttain.SelectedIndex = 5 Then
            cboSEducAttain.Width = 93
            txtOtherSpecify2.Visible = True
            txtOtherSpecify2.Visible = True
        Else
            cboSEducAttain.Width = 263
            txtOtherSpecify2.Visible = False
        End If
    End Sub

    Private Sub chkActiveStatus_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chkActiveStatus.CheckedChanged
        If chkActiveStatus.Checked Then
            lbldueto.Visible = False
            cboInactive.Text = ""
        Else
            lbldueto.Visible = True
            cboInactive.Visible = True
        End If
    End Sub
