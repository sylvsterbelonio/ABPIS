...
Public Class frmNewsLetterFinder
    ...
    Private Sub loadRecord()
        With navMain
            .set_class(mysql)
            .Set_SELECT(" NLID,headings as 'HEADINGS',subheadings as 'SUB-HEADINGS',dtPublished as 'DATE PUBLISHED', encodedBy as 'ENCODED BY', msgFrom as 'MESSAGE FROM' ")
        ...
        Select Case CType(sender, Button).Text
            Case "Search"
                ...
                If cboMonth.Text = "-" Then
                    Concat.Append(x, " dtPublished between '" + txtYear.Text + "-1-1' and '" + txtYear.Text + "-12-31'", " and ")
                Else
                ...
                If MsgBox("Do you want to delete this record?", MsgBoxStyle.YesNo) = MsgBoxResult.Yes Then
                    Try
                        ...
                        If mydata.Rows.Count > 0 Then
                            Try
                                System.IO.File.Delete(Application.StartupPath + "\Documents\" + mydata.Rows(0).Item("dFileName"))
                            Catch ex As Exception
                                MsgBox("There is no file exist in the document", MsgBoxStyle.Information, "Unable to Locate File")
                            End Try
                        End If
